...
//outage causes
var causeDimension = facts.dimension(function(d){return d.properties.Cause});
...
//.size(10)
.group(function(d){})
.columns([{label:'StartTime',format: function(d){return d.date.toLocaleDateString('en-US', options)}},
          {label:'Substation',format: function(d){return d.properties.Substation}},
          {label:'Feeder',format: function(d){return d.properties.Feeder}},
          {label:'Cause',format: function(d){return d.properties.Cause}},
          {label:'# Out',format: function(d){return d.properties.CustomersAffected}}
          ])
...
var dayOfWeekChart = dc.rowChart("#chart")
    .width(250)
    .height(180)
    .margins({top: 20, left: 20, right: 10, bottom: 30})
    .dimension(dayOfWeek)
